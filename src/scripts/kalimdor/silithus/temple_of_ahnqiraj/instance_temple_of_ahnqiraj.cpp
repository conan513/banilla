...
static const DialogueEntry twinsDeathDialogue[] =
{
...
void TwinsIntroDialogue::Start()
{
    ...
    Creature* pEye = GetInstance()->GetSingleCreatureFromStorage(NPC_MASTERS_EYE);
    Creature* pVL = GetInstance()->GetSingleCreatureFromStorage(NPC_VEKLOR);
    Creature* pVN = GetInstance()->GetSingleCreatureFromStorage(NPC_VEKNILASH);
