...
struct boss_mekgineer_steamriggerAI : public ScriptedAI
{
    ...
    void SummonMechanichs()
    {
        ...
        for (uint8 i = 0; i < 3; ++i)
            m_creature->SummonCreature(NPC_STEAMRIGGER_MECHANIC, aSteamriggerSpawnLocs[i].m_fX, aSteamriggerSpawnLocs[i].m_fY, aSteamriggerSpawnLocs[i].m_fZ, 0, TEMPSUMMON_TIMED_COMBAT_OR_DEAD_DESPAWN, 240000);
    }
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        ...
        if (!m_bIsRegularMode)
        {
            ...
            {
                m_creature->SummonCreature(NPC_STEAMRIGGER_MECHANIC, aSteamriggerSpawnLocs[2].m_fX, aSteamriggerSpawnLocs[2].m_fY, aSteamriggerSpawnLocs[2].m_fZ, 0, TEMPSUMMON_TIMED_COMBAT_OR_DEAD_DESPAWN, 240000);
                m_uiMechanicTimer = 20000;
            }
            else
