...
enum eConfigUInt32Values
{
	...
	CONFIG_UINT32_CUSTOM_TALENT_RESET_TOKEN_COST, 
...
enum eConfigFloatValues
{
	...
	CONFIG_FLOAT_CUSTOM_ADVENTURE_CREATURE_POWER_INCR,
...
enum eConfigBoolValues
{
	...
	CONFIG_BOOL_CUSTOM_TALENT_RESET_TOKEN, 
