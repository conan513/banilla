...
namespace LuaPlayer
{
    ...
    int GetHonorStoredKills(lua_State* L, Player* player)
    {
		...
		if (honorable)
			Eluna::Push(L, player->GetHonorMgr().GetTotalHK());
		else
			Eluna::Push(L, player->GetHonorMgr().GetTotalDK());
        return 1;
    }
    ...
    {
        Eluna::Push(L, player->GetHonorMgr().GetLastWeekCP());
        return 1;
    }
#endif
    ...
    {
        player->GetHonorMgr().ClearHonorData();
        return 0;
    }
#endif
    ...
    int SetHonorLastWeekStandingPos(lua_State* L, Player* player)
    {
        ...
        player->GetHonorMgr().SetLastWeekCP(standingPos);
        return 0;
    }
#endif
