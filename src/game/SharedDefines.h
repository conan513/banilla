...
enum SpellSchoolMask
{
	...
	SPELL_SCHOOL_MASK_FF_SPELL = (SPELL_SCHOOL_MASK_FIRE | SPELL_SCHOOL_MASK_FROST | SPELL_SCHOOL_MASK_SHADOW | SPELL_SCHOOL_MASK_ARCANE),
...
enum SpellAttributesEx3
{
	...
	SPELL_ATTR_EX3_CAN_PROC_FROM_TRIGGERED_SPECIAL = 0x04000000,            // 26
...
enum SpellEffects
{
	...
	SPELL_EFFECT_APPLY_AREA_AURA_RAID =		 133,		
	...
	SPELL_EFFECT_145 = 145,  //was 130
	SPELL_EFFECT_PLAY_SOUND = 146, //was 131
	SPELL_EFFECT_QUEST_FAIL = 147,
	SPELL_EFFECT_PLAY_MUSIC = 148, //was 132
	SPELL_EFFECT_CHARGE2 = 149,
	SPELL_EFFECT_UNLEARN_SPECIALIZATION = 150, //was 133
	SPELL_EFFECT_TRIGGER_SPELL_2 = 151,
	SPELL_EFFECT_152 = 152,
	SPELL_EFFECT_153 = 153,
	SPELL_EFFECT_REDIRECT_THREAT = 154, //was 130
    TOTAL_SPELL_EFFECTS                    = 155
};
...
{   // (C) used in caster aura state     (T) used in target aura state
	...
	AURA_STATE_MISS = 25,
	AURA_STATE_BLOCK = 26,
	AURA_STATE_RESIST = 27,
	AURA_STATE_ABSORB = 28,
	AURA_STATE_DODGE = 29,
	AURA_STATE_INTERRUPT = 30,
};
...
enum Targets
{
	...
	TARGET_MEDIUM_FRONTAL_CONE = 94,
	TARGET_FRONTAL_LINE = 95,
};
